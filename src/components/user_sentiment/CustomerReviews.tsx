...
import { Category, ProductReview2 } from "@/types/type";
    ...
    <div className="p-4 bg-white rounded-md shadow-sm">
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h2 className="font-bold w-full text-[22px]">User Feedback</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
          <Select value={selectedTime} onValueChange={(val) => setTime?.(val)}>
            ...
            <SelectContent>
              ...
              <SelectItem value="1 year">This Year</SelectItem>
            </SelectContent>
          </Select>
          ...
          >
            ...
            <SelectContent>
              ...
              {Category?.map((cate) => {
                return (
                  <SelectItem value={String(cate?.category_id)}>
                    {cate?.category_title}
                  </SelectItem>
                );
              })}
