          ...
          <div className="flex border-b-2  pb-1 items-center justify-between flex-wrap gap-2 mb-4">
            <TabsList className="flex translate-y-1.5 gap-2 bg-transparent p-0">
                ...
                Customer Support
                 ...
                 <TabsTrigger
                  value={'reviews'}
                  className=" px-4 py-2 flex gap-x-1.5 items-center text-sm font-medium  transition-colors duration-200 ease-in-out  bg-transparen data-[state=active]:shadow-none   data-[state=active]:border-b-2 border-b-secondary-green   data-[state=active]:bg-transparent data-[state=active]:text-secondary-green"
                >
                Customer Reviews <Badge className="bg-[#E5E7EB] text-black">12</Badge>
