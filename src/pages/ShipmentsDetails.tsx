...
export default function ShipmentsDetails() {
    ...
    if(isSuccess){
      ...
      const { package: packages, shipment } = data;
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-x-2 cursor-pointer" onClick={()=>navigate('/shipments')}>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">AWB: {shipment.awb_code}</p>
                  </div>
                </div>
              ...
              <div className="border rounded-lg bg-white p-4 h-[350px] mt-4">
                ...
                <div className="grid grid-cols-2 grid-rows-3  gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <h3 className="text-primary-black font-medium">
                      {dayjs(shipment.pickup_scheduled_date).format("DD-MM-YYYY, hh:mm A")}
                    </h3>
                  </div>
                  <div className="col-span-1 space-y-1.5">
                  ...
                  <div className="col-span-1 space-y-1.5">
                    ...
                    <h3 className="text-primary-black font-medium">
                      {dayjs(shipment.estimated_delivery_date).format("DD-MM-YYYY, hh:mm A")}
                    </h3>
                  </div>
                  <div className="col-span-1 space-y-1.5">
                  ...
                  <div className="col-span-1 space-y-1.5">
                    ...
                    <h3 className="text-primary-black font-medium">
                      {shipment.delivered_date ? dayjs(shipment.delivered_date).format("DD-MM-YYYY, hh:mm A") : "Yet to be delivered"}
                    </h3>
                  </div>
                  <div className="col-span-1 space-y-1.5">
                    ...
                    <Button onClick={() => window.open(shipment.tracking_link)} variant="ghost" className="text-primary-blue hover:text-primary-blue">
                      View Tracking <Icons.TrackingId />
                    </Button>
                  </div>
                  <div className="col-span-1 space-y-1.5">
                    <p className="text-lead text-sm">Delivered To</p>
                    <h3 className="text-primary-black font-medium">{shipment.delivered_to}</h3>
                  </div>
                </div>
              </div>
            </li>
            ...
            <li className="col-span-1">
              ...
              <div className="border rounded-lg bg-white p-4 mt-5 overflow-y-scroll h-[350px]">
                ...
                {packages.map((item, index) => (
                  <div key={`packagedetails-${index}`} className="mt-4 space-y-5 border-b pb-4">
                    <div className="">
                      <p className="text-lead text-sm">Package Name</p>
                      <p className="text-primary-black font-medium">{item.product_name}</p>
                    </div>
                    <div className="flex justify-between items-center">
                      <p className="text-lead text-sm">Length</p>
                      <p className="text-primary-black font-medium">{item.length ? item.length : "-"}</p>
                    </div>

                    <div className="flex justify-between items-center">
                      <p className="text-lead text-sm">Width</p>
                      <p className="text-primary-black font-medium">{item.breadth ? item.breadth : "-"}</p>
                    </div>
                    <div className="flex justify-between items-center">
                      <p className="text-lead text-sm">Height</p>
                      <p className="text-primary-black font-medium">{item.height ? item.height : "-"}</p>
                    </div>
                    <div className="flex justify-between items-center">
                      <p className="text-lead text-sm">Weight</p>
                      <p className="text-primary-black font-medium">{item.weight ? item.weight : "-"}</p>
                    </div>
                  </div>
                ))}
